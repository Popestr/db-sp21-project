...
try {
	...
	$stmt_charities = mysqli_prepare($con, "SELECT charity_name, subtotal, c.charity_id FROM `Charity_Admins` ca LEFT OUTER JOIN `Charities` c ON c.charity_id = ca.charity_id WHERE admin_id = ?");
...
<html>
	...
	<body class="loggedin">
		...
		<div class="content">
			...
			<h2>Purchases
				<input class="xlarge" id="charityinput" type="search" size="30" value="" placeholder="Charity name contains"></h2>
				...
				<div id="charityresult">
					<table id="user-purchases">
						...
						<?php 
							...
							mysqli_stmt_bind_result($stmt_charities, $cname, $subtotal, $cid);
			...
			<?php if($_SESSION['userrole'] == 'hs2fw_b'): ?>
